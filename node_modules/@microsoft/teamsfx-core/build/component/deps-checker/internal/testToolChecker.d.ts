...
export declare class TestToolChecker implements DepsChecker {
    ...
    private readonly legacyNpmPackageName;
    private readonly checkUpdateTimeout;
    private readonly commandName;
    private readonly npmCommandName;
    private readonly binaryCommandName;
    private readonly portableDirNameNpm;
    private readonly portableDirNameBinary;
    private readonly legacyCommandName;
    private readonly legacyNpmCommandName;
    private readonly legacyBinaryCommandName;
    private readonly legacyPortableDirNameNpm;
    private readonly legacyPortableDirNameBinary;
    ...
    private isBinaryAccessible;
    private checkVersion;
    private queryVersion;
    private runQueryVersion;
...
export declare class GitHubHelpers {
    private static readonly releasePackageName;
    private static readonly artifactNamePrefix;
    static listGitHubReleases(): Promise<GitHubRelease[]>;
}
export {};
